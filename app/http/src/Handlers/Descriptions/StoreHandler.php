...
final class StoreHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $run['id'] = (int) $request->getAttribute('run_id');
        $publication['pmid'] = (int) $request->getAttribute('pmid');
    ...
    private function success(array $run, array $publication, array $association, DescriptionInput $input): ResponseInterface
    {
    ...
    private function failure(ErrorInterface ...$errors): ResponseInterface
    {
        ...
        return $this->responder->errors(...$messages);
    }
